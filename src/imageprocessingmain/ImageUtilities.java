...
// this is our image utilities class
// chang to images are performed by functions of this class
// this is a supporting class for ImageProcessorFrame class
...
//*********************  method to get edge form of image ****************************************************************************//
...
//****************method to reverse the input image***************************************************//
    ...
    public static BufferedImage reverseImageVertically(BufferedImage img) {
        int width = img.getWidth();
        int height = img.getHeight();
        BufferedImage temp = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
        for (int x = width - 1; x >= 0; x--) {
            for (int y = 0; y < height; y++) {
                ...
                temp.setRGB(x, height - 1 - y, rgb);
            }
        }
        return temp;
    }

//    ************* method to crop the image for the purpose of to select a rectangular portion of image ***********//
    
    public static BufferedImage cropImage(BufferedImage img, int fromy, int fromx, int toy, int tox) {
        int width = tox-fromx;
        int height = toy-fromy;
                     System.out.println(width + "," + height);
        BufferedImage temp = img.getSubimage(fromx, fromy, width, height);

        return temp;
    }
    
//***************************method to perform reverse image horizontaly************************//
    
    public static BufferedImage reverseImageHorizontally(BufferedImage img) {
        int width = img.getWidth();
        int height = img.getHeight();
        BufferedImage temp = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
        for (int y = 0; y < height; y++) {
